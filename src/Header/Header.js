  ...
  return (
    <div>
        <nav className=' bg-gradient-to-l from-blue-900 to-blue-600 via-blue-700'>
            <div className='relative w-[1080px] mx-auto flex justify-end'>
                <ul className='flex space-x-6'>
                    ...
                    <div>
                    <button className='rounded-sm my-5 w-20 h-9 text-white border-blue-300 border-2  font-bold text-md hover:text-blue-200 cursor-pointer'>Log in </button>
                    <button className='rounded-sm  mx-4 my-5 w-20 h-9 text-blue-300 bg-white  font-bold text-md hover:text-blue-800 cursor-pointer'>Sign up </button>
                    </div>
                </ul>
            </div>
        </nav>
