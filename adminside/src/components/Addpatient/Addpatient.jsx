  ...
  const addToList = (event) => {
    ...
    if (selectedTopic) {
      ...
      setPatientData((prevData) => ({
        ...
        tests: [
          ...prevData.tests,
          { name: selectedTopic.name, price: selectedTopic.price }
        ],
      }));
    }
  };
  ...
  return (
    ...
    <form className="space-y-6" onSubmit={handleSubmit}>
      ...
      <select
        ...
        className="w-full h-10 border-2 border-gray-500 rounded-lg py-2 px-2 text-gray-700 focus:outline-none focus:border-gray-500"
      >
